        ...
        <div class="box-body">
          <?php echo form_open(); ?>
            <div class="col-md-6 form-group">
              ...
              <input type="text" name="data[leave_fromdate]" class="form-control datepicker" placeholder="Enter From Date" min="0" required="required" data-inputmask="'alias': 'yyyy-mm-dd'" data-mask>
            </div>

            <div class="col-md-6 form-group">
              <label>To Date</label>
              <input type="text" name="data[leave_todate]" class="form-control datepicker" placeholder="Enter To Date" min="0" required="required" data-inputmask="'alias': 'yyyy-mm-dd'" data-mask>
            </div>

            <div class="col-md-12 form-group">
              <label>Reason</label>
              <textarea class="form-control" name="data[leave_reason]" rows="4" style="resize: none;" placeholder="Enter Reason..." maxlength="1024"></textarea>
            </div>
