      ...
      <div class="box">
        <div class="box-body">
          ...
          <table class="table table-bordered table-hover">
            <thead>
              <tr>
                <th>Leave ID <?php $this->general_m->sort_link($url, $sort_column, $sort_order, 'employee_leaveid'); ?></span></a></th>
            ...
            <?php for($i=0; $i<count($requests); $i++) { ?>
              <tr>
                ...
                <td align="center">
                  <a href="<?php echo site_url('faculty/leaves/edit/'.$requests[$i]['faculty_leaveid']); ?>" title="Edit" class="btn btn-primary btn-xs">
                    <i class="fa fa-pencil-square-o"></i>
                  </a> 
                  <a href="<?php echo site_url('faculty/leaves/delete/'.$requests[$i]['faculty_leaveid']); ?>" title="Delete" class="btn btn-danger btn-xs" onclick="return confirm('are you sure you want to delete?'); ">
