      ...
      <div class="box">
        <div class="box-body">
          ...
          <div class="col-md-4 form-group">
            ...
            <input type="text" name="data[date]" class="form-control datepicker" placeholder="Enter Report Date" min="0" required="required" value="<?php echo $report[0]['date']; ?>" data-inputmask="'alias': 'yyyy-mm-dd'" data-mask>
          </div>

          <div class="col-md-4 form-group">
            <label>Subject</label>
            <input type="text" name="data[subject]" class="form-control" placeholder="Enter Subject" value="<?php echo $report[0]['subject']; ?>" required="required">
          </div>

          <div class="col-md-4 form-group">
              <label>No. of Presetnt Student</label>
              <input type="text" name="data[no_of_pre_student]" class="form-control" placeholder="Enter no. of Present student..." value="<?php echo $report[0]['no_of_pre_student']; ?>" required="required">
            </div>

          <div class="col-md-12 form-group">
            <label>Note</label>
            <textarea class="form-control" name="data[Note]" rows="4" style="resize: none;" placeholder="Enter Note..." maxlength="1024"><?php echo $report[0]['note']; ?></textarea>
          </div>
