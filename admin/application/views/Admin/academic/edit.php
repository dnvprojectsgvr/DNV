        ...
        <div class="box-body">
          <?php echo form_open(); ?>
           ...
           <div class="col-md-6 form-group">
            ...
            <input type="text" name="data[from_date]" class="form-control datepicker" placeholder="Enter From Date" min="0" required="required" data-inputmask="'alias': 'yyyy-mm-dd'" data-mask value="<?php echo $academic[0]['from_date']; ?>">
          </div>

          <div class="col-md-6 form-group">
            <label>To Date</label>
            <input type="text" name="data[to_date]" class="form-control datepicker" placeholder="Enter To Date" min="0" required="required" data-inputmask="'alias': 'yyyy-mm-dd'" data-mask value="<?php echo $academic[0]['to_date']; ?>">
          </div>
