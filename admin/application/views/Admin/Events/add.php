  ...
  <div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <div class="box">
        <div class="box-body">
          <?php  echo form_open(); ?>
          <form method="POST" action="<?php // echo site_url('admin/events/add');?>" enctype='multipart/form-data'>
             <!--  <div class="col-md-4 form-group">
              ...
              <div class="col-md-12 form-group">
                ...
                <textarea name="data[class]" class="form-control " placeholder="Enter Event Description" min="0" required="required" ></textarea> 
            </div>
