          ...
          <!-- <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <form action="" method="post">
                <div class="col-md-4">
                  ...
                  <input type="text" class="form-control" name="subject_name" required="required" value="<?php // echo $subject_name; ?>">
                </div>
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <th>subject Name <?php $this->general_m->sort_link($url, $sort_column, $sort_order, 'subject_name'); ?></span></a></th>
              ...
              <tbody>
                ...
                <tr>
                  <td><?php echo $subject[$i]['sub_id']; ?></td>
                  <td><?php echo $subject[$i]['sub_name']; ?></td>
                  <td><?php echo $subject[$i]['sub_crimarks']; ?></td>
                  <td><?php $pract = $subject[$i]['sub_pract'];if ($pract == 1) { echo "Yes";} else{echo "No";} ?></td>
                  <td><?php echo $subject[$i]['sem_name']; ?></td>
                  <td><?php echo $subject[$i]['cur_name']; ?></td>
                  <td><?php echo $subject[$i]['aca_startdate']; ?> - <?php echo $subject[$i]['aca_lastdate']; ?></td>
                  <td align="center">
                    <a href="<?php echo site_url('admin/subject/edit/'.$subject[$i]['sub_id']); ?>" title="Edit" class="btn btn-primary btn-xs">
                      <i class="fa fa-pencil-square-o"></i>
                    </a> 
                    <a href="<?php echo site_url('admin/subject/delete/'.$subject[$i]['sub_id']); ?>" title="Delete" class="btn btn-danger btn-xs" onclick="return confirm('are you sure you want to delete?'); ">
