        ...
        <div class="box-body">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
            ...
            <div class="col-md-4 pull-right">
              <form action="<?php echo site_url('Employee/view_employee'); ?>" method="post" accept-charset="utf-8">
                <div class="box-body">
          ...
          <div class="col-md-12 table-responsive">
              <table class="table table-bordered table-hover">
                    <thead>
                      <tr>
                        <th>Sr.No. <?php $this->general_m->sort_link($url, $sort_column, $sort_order, 'id'); ?></th>
                        <th style="max-width: 80px;">Image</th>
                        <th>Name <?php $this->general_m->sort_link($url, $sort_column, $sort_order, 'name'); ?></th>
                        <th>Designation <?php $this->general_m->sort_link($url, $sort_column, $sort_order, 'designation'); ?></th>
                        <th>Mobile</th>
                        <th>E-mail</th>
                        <th>Action</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><?php echo $b; ?></td>
                        <td><img src="<?php echo base_url('assets/images/employees/picture'.$employee[$i]['id'].'.jpg'); ?>" width="80px"></td>
                        <td><?php echo $employee[$i]['name']; ?></td>
                        <td><?php echo $employee[$i]['designation']; ?></td>
                        <td><a href="tel:<?php echo $employee[$i]['mobile1']; ?>"><?php echo $employee[$i]['mobile1']; ?></td></a>
                        <td><?php echo $employee[$i]['email1']; ?></td>
                        

                        <td align="center">
                          <a href="<?php echo site_url('Employee/detail/'.$employee[$i]['id']); ?>" title="View" class="btn btn-primary btn-xs" ><i class="fa fa-eye"></i></a> |
                          <a href="<?php echo site_url('Employee/delete/'.$employee[$i]['id']); ?>" title="Delete" class="btn btn-danger btn-xs" onclick="return confirm('Do you really want to delete all the data related with this Employee?');">
...
<script type="text/javascript">
  $(document).on('change', '#result_limit', function(){
    window.location = "<?php echo site_url('Employee/view_employee/all'); ?>/" + $(this).val();
  });
</script>
</body>
</html>
