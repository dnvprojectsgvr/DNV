          ...
          <!-- <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <form action="" method="post">
                <div class="col-md-4">
                  ...
                  <input type="text" class="form-control" name="course_name" required="required" value="<?php // echo $course_name; ?>">
                </div>
          ...
          <table class="table table-bordered table-hover">
            <thead>
              <tr>
                ...
                <th> Course Name <?php $this->general_m->sort_link($url, $sort_column, $sort_order, 'course_name'); ?></span></a></th>
                <th>Action</th>     
              </tr>
            </thead>
            <tbody>
            <?php for($i=0; $i<count($course); $i++) { ?>
              <tr>
                <td><?php echo $course[$i]['id']; ?></td>
                <td><?php echo $course[$i]['course_name']; ?></td>
                <td align="center">
                  <a href="<?php echo site_url('admin/course/edit/'.$course[$i]['id']); ?>" title="Edit" class="btn btn-primary btn-xs">
                    <i class="fa fa-pencil-square-o"></i>
                  </a> 
                  <a href="<?php echo site_url('admin/course/delete/'.$course[$i]['id']); ?>" title="Delete" class="btn btn-danger btn-xs" onclick="return confirm('are you sure you want to delete?'); ">
