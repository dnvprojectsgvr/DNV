          ...
          <!-- <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <form action="" method="post">
                <div class="col-md-4">
                  ...
                  <input type="text" class="form-control" name="stream_name" required="required" value="<?php // echo $stream_name; ?>">
                </div>
          ...
          <table class="table table-bordered table-hover">
            <thead>
              <tr>
                ...
                <th>Stream Name <?php $this->general_m->sort_link($url, $sort_column, $sort_order, 'stream_name'); ?></span></a></th>
                <th>Action</th>     
              </tr>
            </thead>
            <tbody>
            <?php for($i=0; $i<count($stream); $i++) { ?>
              <tr>
                <td><?php echo $stream[$i]['id']; ?></td>
                <td><?php echo $stream[$i]['stream_name']; ?></td>
                <td align="center">
                  <a href="<?php echo site_url('admin/stream/edit/'.$stream[$i]['id']); ?>" title="Edit" class="btn btn-primary btn-xs">
                    <i class="fa fa-pencil-square-o"></i>
                  </a> 
                  <a href="<?php echo site_url('admin/stream/delete/'.$stream[$i]['id']); ?>" title="Delete" class="btn btn-danger btn-xs" onclick="return confirm('are you sure you want to delete?'); ">
