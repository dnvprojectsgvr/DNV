...
function calculate()
{
    ...
    $('#service_tax').val(total_service_tax);
    $('#edu_tax').val(total_edu_tax);
    $('#sec_tax').val(total_sec_tax);
    $('#taxable_amount').val(total_taxable_amount);
    $('#nontaxable_amount').val(total_nontaxable_amount);

    var totalamount = parseFloat(total_nontaxable_amount) + parseFloat(total_taxable_amount);

    totalamount = Math.round(totalamount);

    $('#total_payble').val(totalamount);

    inWords($('#total_payble').val());
